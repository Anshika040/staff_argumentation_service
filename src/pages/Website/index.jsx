...
import FormFieldEmptyPage from "pages/FormFieldEmpty";
...
export default function WebsitePage() {
  return (
    <>
      <Helmet>
        <title>
          Success Stories - Achieve Project Efficiency & Cost Savings
        </title>
        <meta
          name="description"
          content="Discover how our platform has revolutionized project execution with a 40% reduction in time and significant cost savings. Explore success stories and onboard top talent today."
        />
      </Helmet>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <div className="mt-[111px] flex items-center justify-between gap-5 self-stretch md:flex-col">
                          <div className="relative h-[596px] w-[59%] md:w-full">
                            <div className="absolute left-[0.00px] top-[0.00px] m-auto flex w-[90%] items-start md:relative md:flex-col">
                              <div className="relative z-[3] mt-[91px] h-[261px] w-[33%] md:w-full">
                                ...
                                <Img
                                  ...
                                  alt="sparkle image"
                                  className="absolute left-[0.00px] top-[0.00px] m-auto h-[101px] w-[102px]"
                                />
                              </div>
                            ...
                            <div className="gray_800_01_gray_800_00_border absolute bottom-[0.00px] right-[0.00px] m-auto flex w-[39%] flex-col items-center gap-[13px] rounded-[28px] border border-solid bg-gray-900_01 pb-[38px] pl-8 pr-[30px] pt-8 shadow-xs sm:p-5">
